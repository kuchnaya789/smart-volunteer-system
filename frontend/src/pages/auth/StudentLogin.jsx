...
export default function StudentLogin() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const name = res.data?.name || localStorage.getItem("name") || "Student";
  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="max-w-xl mx-auto bg-blue-50 border border-blue-100 rounded-xl shadow p-6">
        <div className="text-2xl font-extrabold text-gray-900">Student Login</div>
        <p className="mt-2 text-sm text-gray-700">Sign in to view your assignments and AICTE points.</p>
        ...
        <form className="mt-6 space-y-4" onSubmit={onSubmit}>
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <Link to="/student/register" className="text-sm font-semibold text-blue-700 hover:underline">
