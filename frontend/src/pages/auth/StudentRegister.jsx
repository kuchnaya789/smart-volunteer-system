...
export default function StudentRegister() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const name = res.data?.name || fullName || "Student";
  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="max-w-xl mx-auto bg-blue-50 border border-blue-100 rounded-xl shadow p-6">
        <div className="text-2xl font-extrabold text-gray-900">Student Register</div>
        <p className="mt-2 text-sm text-gray-700">Create your account, then complete your profile to get matched.</p>
        ...
        <form className="mt-6 space-y-4" onSubmit={onSubmit}>
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <Link to="/student/login" className="text-sm font-semibold text-blue-700 hover:underline">
